...
% I'm just making this up really, it depends a lot on the new measurements (which I can't really do because transferring files across 4 open ssh connections is a pain).
% On my machine I got these results, at least, and they were with 8 threads, which from the tables were the lower bounds where the performance with multi-threading were meaningful
